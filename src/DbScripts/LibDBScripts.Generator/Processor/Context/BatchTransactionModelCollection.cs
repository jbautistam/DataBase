...
namespace Bau.Libraries.LibDbScripts.Generator.Processor.Context
{
	/// <summary>
	...
	internal class BatchTransactionModelCollection
	{
		...
		/// </summary>
		internal void Add(IDataProvider provider)
		{
		...
		/// </summary>
		internal void Add(IDataProvider provider, DataProviderCommand command)
		{
		...
		/// </summary>
		internal bool Exists(IDataProvider provider)
		{
