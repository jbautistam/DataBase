...
namespace Bau.Libraries.LibDbScripts.Generator.Processor.Repository
{
	/// <summary>
	...
	internal class DbScriptRepository
	{
		...
		{
			var sentence = new SentencePrint();
		...
		{
			var sentence = new SentenceDeclare();
		...
		{
			var sentence = new SentenceForEach();
