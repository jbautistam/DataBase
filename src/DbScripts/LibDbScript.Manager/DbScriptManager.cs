...
using Bau.Libraries.Aggregator.Providers.Manager;
...
namespace Bau.Libraries.LibDbScripts.Manager
{
	...
	public class DbScriptManager
	{
		...
		public DbScriptManager(DataProviderManager dataProviderManager, Dictionary<string, object> parameters)
		{
		...
		/// </summary>
		internal DataProviderManager DataProviderManager { get; }
