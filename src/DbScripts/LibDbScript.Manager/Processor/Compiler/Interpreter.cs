...
namespace Bau.Libraries.LibDbScripts.Manager.Processor.Compiler
{
	/// <summary>
	...
	{ 
		...
		{
			return ReplaceVariables(text, context.VariablesTable, true, out error);
		}
		...
		{
			return ReplaceVariables(text, context.VariablesTable, false, out error);
		}
