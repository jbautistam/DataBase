...
namespace Bau.Libraries.LibDBSchema
{
	...
	public class Schema
	{
		...
		///		Tablas
		/// </summary>
		public SchemaTablesCollection Tables { get; }

		/// <summary>
		///		Desencadenadores
		/// </summary>
		public SchemaTriggersCollection Triggers { get; }

		/// <summary>
		///		Vistas
		/// </summary>
		public SchemaViewsCollection Views { get; }

		/// <summary>
		///		Rutinas
		/// </summary>
		public SchemaRoutinesCollection Routines { get; }
	}
}
